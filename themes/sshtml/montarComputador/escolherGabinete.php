<?php
if (@$_POST['armazenamento'] == " ") {
  $_SESSION['Info'] = "Erro começe denovo";
  $_SESSION['Type'] = "danger";
  header("Location: escolherArmazenamento");
}
  ...
  <div class="row">
    <div class="col-xl-12 col-md-12">
      <div class="box-escolha-purple text">
        <div class="h3-white text-center">Escolha o Gabinete</div>
        <form class="form-outline col-lg-11 mb-2 text-center" id="form" action="escolherFonte" method="post" style="margin: 10px 50px 10px!important;">
          <select class="form-control" name="gabinete" id="peca">
          <option value="0">Selecione uma Opção</option>
            <hr class="line">
            <?php foreach ($gabinetes as $gabinete) : ?>
              <?php $preco = $computador->buscarMediaValor($gabinete['cod_produto']); ?>
              <option value="<?= $gabinete['cod_produto'] ?>"><?= $gabinete['nome'] ?>
              </option>
            <?php endforeach; ?>
          </select>
          <br>
