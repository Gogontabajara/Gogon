  ...
  <div class="row">
    <div class="col-xl-12 col-md-12">
      <div class="box-escolha-purple text">
        <div class="h3-white text-center">Escolha a Terceira memoria</div>
        <form class="form-outline col-lg-11 mb-2 text-center" id="form" action="escolherMemoria4" method="post" style="margin: 10px 50px 10px!important;">
          <select class="form-control" name="memoria3" id="peca">
    ...
    <div class="container mt-2">
      <div class="row">
        ...
        <a href="escolherMemoria2"><button class="btn btn-info btn-md btn-block btn-lg" type="submit">Voltar</button></a>
        </div>
        <div class="col-xl-6 col-md-12 mb-4">
